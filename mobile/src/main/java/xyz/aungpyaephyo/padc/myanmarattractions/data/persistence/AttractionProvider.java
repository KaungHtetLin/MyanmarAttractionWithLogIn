 ...
 */
public class AttractionProvider extends ContentProvider {  //one class in one application
    ...
    public boolean onCreate() {
        mAttractionDBHelper = new AttractionDBHelper(getContext());  //create and store db object
        return true;
    }
