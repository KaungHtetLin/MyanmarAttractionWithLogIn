 ...
 */
public class RetrofitDataAgent implements AttractionDataAgent {  //singleton object
    ...
    private RetrofitDataAgent() {
        ...
        theApi = retrofit.create(AttractionApi.class);  //interface not need to implement . framework will done
    }
    ...
    public void loadAttractions() {
        ...
        loadAttractionCall.enqueue(new Callback<AttractionListResponse>() {  //preparatin state  before request
            @Override
