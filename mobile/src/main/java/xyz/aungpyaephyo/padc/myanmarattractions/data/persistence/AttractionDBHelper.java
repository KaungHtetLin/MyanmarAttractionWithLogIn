 ...
 */
public class AttractionDBHelper extends SQLiteOpenHelper{  //one for one application

    private static final int DATABASE_VERSION = 2;
    public static final String DATABASE_NAME = "attractions.db";

    //CAP is sql command   . AttractionEntry._ID is get from BaseColumns
    private static final String SQL_CREATE_ATTRACTION_TABLE = "CREATE TABLE " + AttractionEntry.TABLE_NAME + " (" +
            ...
            " UNIQUE (" + AttractionEntry.COLUMN_TITLE + ") ON CONFLICT IGNORE" +  // can't duplicate
            " );";  //sql command
    ...
    @Override
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int i, int i1) {  //delete(drop) and recreate
